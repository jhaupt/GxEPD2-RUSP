...
#ifndef _GxEPD2_290_flex_H_
#define _GxEPD2_290_flex_H_

#include "../GxEPD2_EPD.h"

class GxEPD2_290_flex : public GxEPD2_EPD
{
  public:
    // attributes
    static const uint16_t WIDTH = 128;
    static const uint16_t HEIGHT = 296;
    static const GxEPD2::Panel panel = GxEPD2::GDEW029I6F;
    ...
    static const uint16_t full_refresh_time = 600; // ms, e.g. 2056899us
    static const uint16_t partial_refresh_time = 300; // ms, e.g. 283622us
    // constructor
    GxEPD2_290_flex(int8_t cs, int8_t dc, int8_t rst, int8_t busy);
    // methods (virtual)
